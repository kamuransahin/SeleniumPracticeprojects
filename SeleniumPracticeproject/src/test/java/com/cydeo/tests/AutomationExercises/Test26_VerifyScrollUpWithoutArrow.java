...
public class Test26_VerifyScrollUpWithoutArrow {

 @Test
 public void verify_scroll_up_test(){
    ...
    //2. Navigate to url 'http://automationexercise.com'
     ...
     WebElement automationExercise=Driver.getDriver().findElement(By.xpath("//img[@alt='Website for automation practice']"));
     actions.moveToElement(automationExercise).perform();
